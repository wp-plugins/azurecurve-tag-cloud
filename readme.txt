...
== Description ==
The plugin integrates with the standard WordPres tag cloud, but allows tags to be excluded and easy control of other settings such as min and max font sizes, the sort order and number of tags to include. 
